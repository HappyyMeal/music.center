...
<body>
	...
	<div class="slide story" id="slide-1" data-slide="1"
		...
		<form class="form-inline" role="form"
			action="/mc-client/playlist/save" method="post">
			<label class="sr-only" for="playlistName">Название плейлиста:</label>
			<div class="form-group">
				<input type="text" class="form-control" id="playlistName"
					name="playlistName" placeholder="Название плейлиста" required>
			</div>
